...
grade.append('C/TSgt')
grade.append('C/MSgt')
cadet_name.append('Dewanz')
cadet_name.append('Jeseritz')
print(f"hello {grade[-1]} {cadet_name[5]}")
cadet_name.insert(1, 'Christensen')
print("list with new name ", cadet_name)
